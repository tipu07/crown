	...
	return (
		<>
			<div className={style.content}>
				...
				<p>CCP takes pride in our clients' satisfaction. Our goal is to get in direct contact with the credit bureaus to fight for you. At times our jobs can be challenging and that can be based on the responses from the bureaus and creditors but we ensure that we’ll get the job done.</p>
				<br />
				<p>In some cases, CCP will get a refund request from client’s who can also be challenged along the way while helping them achieve good credit.</p>
				<br />
				<p>
					A refund is only due when services are paid in full upon signing up for services. The 120 business day’s money back guarantee doesn’t apply to clients who have split their payments in two and haven't paid their balance past the 30 day due date. <br />
					...
					Upon receiving a request for refund, CCP will review your file thoroughly to ensure what items were not disputed from your credit profile and if there are any items that are still remaining from your credit profile from CCP’s original dispute attempts, then a refund will be due at the end of the business days. <br />
				...
				<ul>
					...
					<li>Getting in contact or communicating with the creditors or the bureaus without CCP’s consent.</li>
				</ul>
