...
import { CashAppIcon, TickIcon, PlayIcon, ProfessionalWoman, SaveIcon, ZelleIcon } from "@/components/images"
					...
					<>
						<fieldset>
							...
							<div className={`${style.btn_blk} justify-content-end mt-5`}>
								...
								<button type="button" className={style.site_btn} onClick={() => setFieldset("UploadDocuments")}>
									Next
								</button>
							</div>
						</fieldset>
					...
					<>
						<fieldset>
							...
							<div className={`${style.btn_blk} justify-content-end mt-5`}>
								...
								<button type="button" className={style.site_btn} onClick={() => setFieldset("Agreement")}>
									Next
								</button>
							</div>
						</fieldset>
					...
					<>
						<fieldset>
							...
							<div className={`${style.btn_blk} justify-content-end mt-5`}>
								...
								<button type="button" className={style.site_btn} onClick={() => setFieldset("PoliciesProcedures")}>
									Next
								</button>
							</div>
						</fieldset>
					...
					<>
						<fieldset>
							...
							<div className={`${style.btn_blk} justify-content-end mt-5`}>
								...
								<button type="button" className={style.site_btn} onClick={() => setFieldset("PaymentDetails")}>
									Next
								</button>
							</div>
						</fieldset>
					...
					<>
						<fieldset>
							...
							<div className={`${style.btn_blk} justify-content-end mt-5`}>
								...
								<button type="button" className={style.site_btn} onClick={() => setFieldset("Success")}>
									Submit Application
								</button>
							</div>
						</fieldset>
